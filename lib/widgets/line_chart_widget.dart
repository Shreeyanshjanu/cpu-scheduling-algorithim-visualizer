...
class LineChartWidget extends StatelessWidget {
  ...
  LineChartData _buildLineChartData(
    ...
    return LineChartData(
      ...
      maxY: chartMaxY,
      lineBarsData: [
        // Completion Time - CYAN (like reference)
        _buildLineData(
          processTimes,
          executionOrder,
          (times) => times.completionTime.toDouble(),
        ...
        // Turnaround Time - RED/PINK (like reference)
        _buildLineData(
          processTimes,
          executionOrder,
  ...
  Widget _buildLegend() {
    return Wrap(
      ...
      runSpacing: 8,
      children: [
        _buildLegendItem('Completion', Colors.cyan.shade600),
        _buildLegendItem('Turnaround', Colors.red.shade400),
      ],
    );
  }
